...
* New items are only stocked in lists they were added to -- if enabled new items won't be marked as "stocked here" for lists they were not automatically added to (see above for the setting to which lists items are automatically added to).
